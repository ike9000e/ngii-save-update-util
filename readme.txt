...
----------------------------------
	...
	All codes that are set to [00 00 00 00] are free slots, the game will skip over them.
	This first address, almost certainly, will correspond to Dragon Sword.
	Change it to [00 07 01 00] to have Dragon Sword level 4 or
	change it to [00 01 01 01] to have Dragon Sword level 2.
	(Codes for DS level 1 and 3 are [00010100] and [00010102], respectively).
